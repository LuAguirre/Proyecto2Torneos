...
namespace Administracion_Torneos.Vista
{
    public partial class TorneoCRUD : Form
    {
        ...
        {
            this.Hide(); //escondemos el form actual  y mostramos el menu 
            MenucontrolAdministrador m = new MenucontrolAdministrador(1);
            m.Show();
        }
        ...
        private void TorneoCRUD_FormClosing(object sender, FormClosingEventArgs e)
        {
