...
namespace Administracion_Torneos.Vista
{
    public partial class ViewEquipo : Form
    {
        ...
        {
            this.Hide();
            MenucontrolAdministrador m = new MenucontrolAdministrador(0);
            m.Show();
        }
        ...
        private void ViewEquipo_Load(object sender, EventArgs e)
        {

        }

        private void ViewEquipo_FormClosing(object sender, FormClosingEventArgs e)
        {
