...
namespace Administracion_Torneos.BD
{
    public class arbitroDB
    {
            ...
            using (SqlConnection conexion = new SqlConnection(connectionstring))
            {
                ...
                try
                {
                    ...
                    while (reader.Read())
                    {
                        ...
                        arbitroo.Dpi = reader.GetInt32(0);
        ...
        public void actualizar_arbitro(int? DPI, string Nombre, string Apellidos, string Direccion,string telefono,string Nacionalidad,DateTime FechaNac,string Correo,string Rol)
        {
        ...
        public void eliminar_arbitro(int? id)
        {
