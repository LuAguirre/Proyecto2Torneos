            ...
            using (SqlConnection conexion = new SqlConnection(connectionstring))
            {
                ...
                try
                {
                    ...
                    while (reader.Read())
                    {
                        ...
                        partidoss.hora_inicio = reader.GetDateTime(7);
                        partidoss.hora_fin = reader.GetDateTime(8);
            ...
            using (SqlConnection conexion = new SqlConnection(connectionstring))
            {
                ...
                try
                {
                    ...
                    while (reader.Read())
                    {
                        ...
                        partidoss.hora_inicio = reader.GetDateTime(5);
                        partidoss.hora_fin = reader.GetDateTime(6);
