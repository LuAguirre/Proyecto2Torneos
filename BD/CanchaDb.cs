...
namespace Administracion_Torneos.BD
{
    public class CanchaDb
    {
        ...
        {
            string query = $"INSERT INTO CANCHA( Nombre, Capacidad, estatus) VALUES ( @Nombre, @Capacidad, @estatus)";
            using (SqlConnection connection = new SqlConnection(connectionString))
            {
                SqlCommand sql = new SqlCommand(query, connection);
        ...
        public void UpdateCancha(int NoCancha, string Nombre, string Capacidad, string estatus)
        {
            string query = "UPDATE CANCHA set Nombre=@Nombre, Capacidad=@Capacidad, estatus=@estatus WHERE NoCancha=@NoCancha";
            using (SqlConnection connection = new SqlConnection(connectionString))
            {
